...
from core import ResNet_version9
...
LOG_DIR = './log_version8/'
CHECKPOINT_DIR = './checkpoint_version8/'
NUM_CLASSES = 9
BATCHSIZE = 200
LEARNINT_RATE = 0.001
EPOCHS = 1000
...
ResNetModel = ResNet_version9.ResNetModel(is_training, depth, NUM_CLASSES)
#with tf.name_scope("ResNet"):
#    fc_image = ResNetModel.inference(x)
with tf.name_scope("visit"):
    fc_visit = ResNet_version9.visit_network(visit_array1, is_training)
net_output = ResNet_version9.get_net_output(fc_visit=fc_visit, classNum=NUM_CLASSES, KEEP_PROB=keep_prob)
...
with tf.name_scope("train"):
    ...
    train_layers = ["visit_scale1", "visit_scale2", "visit_scale3", "fc"]
